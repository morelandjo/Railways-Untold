...
class DirectionUtilTest {
    ...
    // NOTE: generateExplorationTargetAvoiding is 1.21.1-only (branch drift - absent from 1.20.1's
    // DirectionUtil), so its ExplorationTargetAvoiding cases live only in the 1.21.1 test.
}
