 ...
 *
 * ({@code LoopDetectionState} is intentionally not covered - its only public method is {@code recordPosition}
 * with no accessor, so its dedup/eviction is unobservable in isolation; see head-refactor.md.)
 */
