...
/**
 * Data classes for boundary segment tracking.
 */
public class BoundarySegmentData {
    ...
    /**
     * Represents a completed track segment.
     */
    public static class ConnectedSegment {
        ...
        public ConnectedSegment(BlockPos start, BlockPos end, ConnectionType type) {
            this(start, end, type, null, null);
        }

        public ConnectedSegment(BlockPos start, BlockPos end, ConnectionType type, List<BlockPos> curvePositions) {
            this(start, end, type, curvePositions, null);
        }
