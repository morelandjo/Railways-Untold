...
public abstract class AbstractPlacementExecutor implements PlacementExecutor {
    ...
    /**
     * True if the detected crossing is a clean grade-separated perpendicular crossing - the proposed
     * track passes over or under a perpendicular existing line with enough rail-to-rail clearance for
     * the lower line's train to pass beneath the upper structure. Such a crossing is not a collision:
     * the two lines occupy different Y at the single column where they meet, which is precisely what the
     * over/under resolver plans.
     */
