...
public class ConnectedBoundaryTracker {
    ...
    /**
     * Registers a segment as connected after track placement succeeds.
     *
    ...
    public static void confirmSegment(ServerLevel level, BlockPos start, BlockPos end,
                                       ConnectionType type, List<BlockPos> curvePositions) {
        markSegmentAsConnected(level, start, end, type, curvePositions, null);
    }
