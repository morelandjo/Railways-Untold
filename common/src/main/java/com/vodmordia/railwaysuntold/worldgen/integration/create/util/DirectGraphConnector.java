...
public final class DirectGraphConnector {
    ...
    private static TrackGraph mergeGraphs(TrackGraph graph1, TrackGraph graph2) {
        ...
        // Note: TrackGraphMergeEvent posting requires Forge API (not available in common module).
        // TrackGraphReadyListener handles this via tick-based polling as a fallback.
