...
import com.vodmordia.railwaysuntold.worldgen.head.state.HeadStateSnapshot;
...
public class ExpansionHeadManager {
    ...
    public void restoreFromSavedData(TrackPlacementSavedData savedData, ServerLevel level) {
        ...
        // Restore nextHeadNumber from saved data
        ...
        for (TrackHeadPersistenceData headData : savedHeads) {
            try {
                ...
                // Reconstruct StationZone if runway was confirmed
                ...
                // Restore state via snapshot builder
                HeadStateSnapshot snapshot = HeadStateSnapshot.builder()
                ...
                // Re-cache the village assignment to prevent orphaned assignments after restart
                if (headData.targetVillageId != null && headData.targetVillageCenter != null) {
                    // Re-create VillageInfo from saved data and cache it
    ...
    /**
     * Validates that all parent head references point to existing heads.
     */
    ...
    public TrackExpansionHead createBranch(TrackExpansionHead parent, BlockPos branchPosition, Direction branchDirection,
        ...
        // Generate head ID upfront so we can register village assignment before creating the head
    ...
    /**
     * Checks if heads have been restored from saved data or initialized.
     */
    ...
    /**
     * Gets all active (non-complete) heads.
     */
    ...
    /**
     * Gets all paused heads (active but waiting for player to return).
     */
    ...
    /**
     * Rebuilds the cached active heads list.
     */
    ...
    /**
     * Invalidates the active heads cache.
     */
    ...
    /**
     * Gets the number of active (non-complete) heads.
     */
    ...
    /**
     * Attempts to assign villages to a list of heads if village targeting is enabled.
     */
