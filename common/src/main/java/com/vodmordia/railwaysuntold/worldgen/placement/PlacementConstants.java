...
public final class PlacementConstants {
    ...
    private PlacementConstants() {} // Prevent instantiation
    ...
    /**
     * Minimum lookahead distance required before terrain planning can activate.
     */
    public static final int PLANNING_MIN_LOOKAHEAD = 32;
