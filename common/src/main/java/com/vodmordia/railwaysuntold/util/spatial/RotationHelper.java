...
public class RotationHelper {
     ...
     *
     * @param level    The level accessor (unused in 1.20.1 but kept for API compatibility)
     * @param pos      The block position (unused in 1.20.1 but kept for API compatibility)
