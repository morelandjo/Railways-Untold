...
public class VillageTargetingState implements PathExecutionState {
    ...
    // Cached approach waypoint - the point ~120 blocks out from the station where normal approach begins.
    // Stored at assignment time so diagonal travel can target it instead of the steering target.
    @Nullable
    private BlockPos approachWaypoint;
