...
public class NoiseStationPositionCalculator {
     ...
     * Without this, a head approaching perpendicular to the track overshoots the
     * station Z/X and must S-curve back.
     */
    ...
    public static BlockPos offsetToApproachWaypoint(BlockPos stationPos, Direction approachDir, BlockPos headPos) {
        ...
        // Offset along the track axis (toward the head) so it approaches parallel
        ...
        // approachDir is the side the station is on (e.g., NORTH = station on north
        // side, head coming from north). Offset in the approachDir direction pushes
        // the waypoint further from the village center, toward the head.
