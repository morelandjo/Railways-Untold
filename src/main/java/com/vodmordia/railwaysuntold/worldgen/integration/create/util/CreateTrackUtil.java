...
public final class CreateTrackUtil {
    ...
    private static Object shapeProperty = null;
    private static Object hasBEProperty = null;
    ...
    static {
        try {
            setValueMethod = BlockState.class.getMethod("setValue",
                    net.minecraft.world.level.block.state.properties.Property.class,
                    Comparable.class);
        } catch (NoSuchMethodException e) {
            LOGGER.error("[CREATE-TRACK] Failed to find BlockState.setValue method: {}", e.getMessage());
        }
        ...
        try {
            ...
            try {
                shapeProperty = trackBlockClass.getField(CreateReflectionFields.SHAPE).get(null);
                hasBEProperty = trackBlockClass.getField(CreateReflectionFields.HAS_BE).get(null);
        ...
        try {
            net.minecraft.resources.ResourceLocation fakeTrackId =
                    net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("railwaysuntold", "fake_track");
    ...
    private static BlockState getStraightTrackInternal(Direction direction, boolean withBlockEntity) {
        ...
        try {
            ...
            return (BlockState) setValueMethod.invoke(shapedState, hasBEProperty, withBlockEntity);
     ...
     * @param withBlockEntity If true, sets HAS_BE=true; if false, sets HAS_BE=false
     * @return Configured BlockState for the diagonal track
     */
    ...
    public static net.minecraft.core.BlockPos calculateCurveEndpoint(
        ...
        if (angle == 90) {
            ...
            int forwardDist = (int) (radius * 1.4);
            int sideDist = (int) (radius * 0.7);
