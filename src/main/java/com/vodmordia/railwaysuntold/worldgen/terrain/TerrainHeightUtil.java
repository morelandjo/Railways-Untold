...
public class TerrainHeightUtil {
    ...
    /**
     * Result of scanning down from heightmap to find solid ground and/or water surface.
     */
    private record GroundScanResult(Integer solidGroundY, Integer waterSurfaceY) {
    }

    /**
     * Scans down from startY to find solid ground and water surface.
     *
     * @param chunk  The loaded chunk
     * @param x      X coordinate
     * @param z      Z coordinate
     * @param startY Y to start scanning from
     * @param minY   Minimum Y to scan to
     * @param waterSurfaceOffset Offset applied to water Y (0 for getGroundLevel, 1 for getRawGroundLevel)
     * @param solidOffset        Offset applied to solid ground Y (0 for getGroundLevel, 1 for getRawGroundLevel)
     * @param checkTrackBlocks   Whether to skip track blocks (true for getGroundLevel)
     * @param stopOnSolidBelowWater Whether to stop scanning when solid ground is found below water
     * @return Scan result with solid ground and water surface Y values (may be null)
     */
    ...
    public static int getGroundLevel(ServerLevel level, BlockPos pos, RailwaysUntoldConfig config) {
        ...
        // Use solid ground or water surface - only fall back to heightmap if neither found.
        int baseHeight;
    ...
    public static int getRawGroundLevel(ServerLevel level, int x, int z) {
        ...
        // waterSurfaceOffset=1 and solidOffset=1 because getRawGroundLevel returns position above the block
