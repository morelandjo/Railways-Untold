...
public class StartingTrainPlacer {
    ...
    public static boolean ensureTrainDataLoaded(ServerLevel level, BlockPos placementPos) {
        ...
        ResourceLocation trainNbtLocation = ResourceLocation.fromNamespaceAndPath("railwaysuntold", "structure/train.nbt");
        try {
            ...
            try (java.io.InputStream stream = resource.open()) {
                nbt = net.minecraft.nbt.NbtIo.readCompressed(stream, net.minecraft.nbt.NbtAccounter.unlimitedHeap());
            }
    ...
    public static TrainPlacementResult placeTrain(ServerLevel level,
        ...
        int clearHeight = Math.max(RailwaysUntoldConfig.getVerticalExpansion(), trainHeight + 1);
