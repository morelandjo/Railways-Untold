...
public class BridgeSchematicPlacer {
    ...
    private static final ResourceLocation FALLBACK_DECKING_ID =
            ResourceLocation.fromNamespaceAndPath("railwaysuntold", "structure/bridge_cross_section.nbt");
    private static final ResourceLocation FALLBACK_END_ID =
            ResourceLocation.fromNamespaceAndPath("railwaysuntold", "structure/decking_end.nbt");
    ...
    private static final ResourceLocation FALLBACK_PIER_ID =
            ResourceLocation.fromNamespaceAndPath("railwaysuntold", "structure/bridge_pillar.nbt");
    ...
    private static final ResourceLocation FALLBACK_RAILING_ID =
            ResourceLocation.fromNamespaceAndPath("railwaysuntold", "structure/bridge_railing.nbt");
    ...
    private static ResourceLocation diagVariant(ResourceLocation base) {
        ...
        return ResourceLocation.fromNamespaceAndPath(base.getNamespace(), diag);
    }
    ...
    private static int deckSurfaceRow(LoadedSchematic profile, int deckColumn) {
        for (int y = profile.getHeight() - 1; y >= 0; y--) {
            ...
            if (!s.isAir() && !s.is(net.minecraft.world.level.block.Blocks.STRUCTURE_VOID)) {
                return y;
            }
        }
        return 0;
