...
public class CoarseRouteExecutionRule implements PlacementRule {
    ...
    /**
     * Checks if a branch should be placed at this position, integrated into the coarse route
     * pipeline so it can execute before terrain planning commits to a segment.
     */
